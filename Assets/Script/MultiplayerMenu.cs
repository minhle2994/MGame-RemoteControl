...
public class MultiplayerMenu : MonoBehaviour {
	...
	public void onClick(){
		GameObject obj = GameObject.FindGameObjectWithTag("Code");
		Text code = obj.GetComponent<Text>();
		if (code != null){
	...
	void OnFinalFailedToConnect (){
		GameObject obj = GameObject.FindGameObjectWithTag("WarningText");
		Text warning = obj.GetComponent<Text>();
		warning.text = "Invalid code";
	...
	void OnConnectedToServer (){
		GameSettings.Clear();
		GameObject input = GameObject.FindGameObjectWithTag("InputCodeField");
	...
	[RPC]
	void Waiting(){	
		GameObject obj = GameObject.FindGameObjectWithTag("IntroText");
		obj.GetComponent<Text>().text = "Waiting for other player";	
	}	
